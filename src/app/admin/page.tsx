    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader className="bg-green-50">
              <CardTitle className="text-green-900">⚙️ Administração</CardTitle>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader className="bg-purple-50">
              <CardTitle className="text-purple-900">👤 Minha Conta</CardTitle>
              <CardDescription>Gerenciamento da conta pessoal</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
              <Button 
                variant="outline" 
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent className="space-y-3 text-sm">
              <div className="p-3 bg-gray-50 rounded">
                ...
                <p><strong>Criado:</strong> {new Date(user.createdAt).toLocaleDateString('pt-BR')}</p>
              </div>
              <div className="text-center">
                <LogoutButton />
              </div>
        ...
        <div className="mt-8 text-center text-gray-500">
          ...
          <p className="text-sm mt-1">© 2025 Projeto Mais Vida</p>
        </div>
      </div>
    </div>
  );
